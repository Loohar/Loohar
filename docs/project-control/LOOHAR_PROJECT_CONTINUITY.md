...
| `release/loohar-pilot-rc-v01` | `796e830` | Release candidate. 2026-09-19 chain: log-noise fix, CI, uptime+runbooks, dependency advisories, native apps. Previous: `9256ce6`, `4f69015` |
...
| Staging | API `https://loohar-api-staging.onrender.com` | `796e83032a735d59a337419dc2a1da6f4aaaffd1` | 2026-09-20 live, `/health` ok, schema 0 issues, `ALLOW_NATIVE_APP_ORIGINS=true`, `EXTRA_CORS_ORIGINS` set |
