...
assert.ok(paymentScreen.includes("disabled={!quoteReady || !canAcceptCash || !cashTender.covered || saving}"), "unverified totals and insufficient cash should disable settlement");
