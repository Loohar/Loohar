...
assertCheck(authResponseBlock.includes("createAuthSession({ user, req, mfaVerifiedAt })") && authResponseBlock.includes("signAccessToken(user, issuedSession.session)"), "Login response is bound to a persisted device session");
